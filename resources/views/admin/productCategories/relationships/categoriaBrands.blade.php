    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-categoriaBrands">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.brand.fields.marca') }}
                            </th>
                            <th>
                                {{ trans('cruds.brand.fields.categoria') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-categoriaBrands:not(.ajaxTable)').DataTable({ buttons: dtButtons })
