                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('place_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.places.index') }}">
                                    ...
                                    @endcan
                                    @can('witness_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.witnesses.index') }}">
                                            {{ trans('cruds.witness.title') }}
                                        </a>
                                    @endcan
                                    @can('checkin_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.checkins.index') }}">
                                            {{ trans('cruds.checkin.title') }}
                                        </a>
                                    @endcan
                                    @can('checkout_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.checkouts.index') }}">
                                    ...
                                    @endcan
                                    @can('variante_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.variantes.index') }}">
                                    ...
                                    @endcan
                                    @can('segment_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.segments.index') }}">
                                            {{ trans('cruds.segment.title') }}
                                        </a>
                                    @endcan
                                    @can('clasification_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.clasifications.index') }}">
