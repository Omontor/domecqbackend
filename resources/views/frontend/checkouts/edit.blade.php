    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.checkouts.update", [$checkout->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="datetime">{{ trans('cruds.checkout.fields.datetime') }}</label>
                            <input class="form-control datetime" type="text" name="datetime" id="datetime" value="{{ old('datetime', $checkout->datetime) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lat" id="lat" value="{{ old('lat', $checkout->lat) }}" required>
                            @if($errors->has('lat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lng" id="lng" value="{{ old('lng', $checkout->lng) }}" required>
                            @if($errors->has('lng'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lng') }}
                                </div>
