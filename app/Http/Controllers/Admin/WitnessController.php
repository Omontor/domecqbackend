...
class WitnessController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.witnesses.create', compact('appointments', 'witness_categories'));
    }
    ...
    public function edit(Witness $witness)
    {
        ...
        return view('admin.witnesses.edit', compact('appointments', 'witness', 'witness_categories'));
    }
