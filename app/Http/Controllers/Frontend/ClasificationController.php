...
class ClasificationController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.clasifications.index', compact('clasifications'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.clasifications.create');
    }
    ...
    public function store(StoreClasificationRequest $request)
    {
        ...
        return redirect()->route('frontend.clasifications.index');
    }
    ...
    public function edit(Clasification $clasification)
    {
        ...
        return view('frontend.clasifications.edit', compact('clasification'));
    }
    ...
    public function show(Clasification $clasification)
    {
        ...
        return view('frontend.clasifications.show', compact('clasification'));
    }
