...
class VarianteController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.variantes.index', compact('variantes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.variantes.create', compact('marcas'));
    }
    ...
    public function store(StoreVarianteRequest $request)
    {
        ...
        return redirect()->route('frontend.variantes.index');
    }
    ...
    public function edit(Variante $variante)
    {
        ...
        return view('frontend.variantes.edit', compact('marcas', 'variante'));
    }
    ...
    public function show(Variante $variante)
    {
        ...
        return view('frontend.variantes.show', compact('variante'));
    }
