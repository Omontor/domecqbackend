...
class AppointmentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.appointments.create', compact('clients', 'executives', 'statuses'));
    }
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('frontend.appointments.edit', compact('appointment', 'clients', 'executives', 'statuses'));
    }
