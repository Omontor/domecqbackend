...
class VisitReportController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.visitReports.create', compact('clients', 'productos', 'users'));
    }
    ...
    public function edit(VisitReport $visitReport)
    {
        ...
        return view('frontend.visitReports.edit', compact('clients', 'productos', 'users', 'visitReport'));
    }
