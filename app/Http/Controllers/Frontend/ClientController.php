...
class ClientController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.clients.create', compact('clasificacions', 'ejecutivos', 'grupos', 'kams', 'mayoristas', 'segmentos', 'statuses', 'variantes'));
    }
    ...
    public function edit(Client $client)
    {
        ...
        return view('frontend.clients.edit', compact('clasificacions', 'client', 'ejecutivos', 'grupos', 'kams', 'mayoristas', 'segmentos', 'statuses', 'variantes'));
    }
